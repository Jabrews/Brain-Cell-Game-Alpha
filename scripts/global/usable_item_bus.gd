...
# defect #
signal toggle_show_defect_pop_up(toggle_value : bool, selected_cell : BrainCell, useable_item_obj : UseableItemObject)
signal defect_pop_up_chose_stat(selected_stat : String, selected_cell : BrainCell, useable_item_obj : UseableItemObject )
