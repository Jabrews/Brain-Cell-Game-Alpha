...
signal use_scissors_stat(selected_cell : BrainCell, useable_item_obj : UseableItemObject, selected_stat : String)
signal use_scissors_mutation(selected_cell : BrainCell, useable_item_obj : UseableItemObject, selected_mutation_type : String)
