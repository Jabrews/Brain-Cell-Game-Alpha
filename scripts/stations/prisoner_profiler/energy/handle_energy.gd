...
func _update_energy_stat_value_used(stat_type : String, new_value : int) -> void:
	...
	match stat_type:	
		'strength': 
			stat_value_energy_used['strength'] = -energy_decrease
		'intelligence': 
			stat_value_energy_used['intelligence'] = -energy_decrease
		'community':
			stat_value_energy_used['community'] = -energy_decrease
...
func _update_energy_toggle_stat_value_enabled(stat_type : String, toggle_value : bool, last_value : int) -> void:
	...
	if toggle_value == false:
		match stat_type:
			'strength': 
				stat_value_energy_used['strength'] = 10
			'intelligence': 
				stat_value_energy_used['intelligence'] = 10
			'community':
				stat_value_energy_used['community'] = 10
