...
@onready var skull : TextureRect = $"../../../BreedingUI/CellLoader/BreedingView/DeathChanceDisplay/Skull"
@onready var left_total_death_chance_label : Label = $"../../../BreedingUI/CellLoader/BreedingView/DeathChanceDisplay/LeftDeathChanceDisplay/TotalDeathChance/DeathChancePercant"
@onready var right_total_death_chance_label : Label =$"../../../BreedingUI/CellLoader/BreedingView/DeathChanceDisplay/RightDeathChanceDisplay/TotalDeathChance/DeathChancePercant" 
...
func _display(cell_1 : BrainCell, cell_2 : BrainCell) -> void:
