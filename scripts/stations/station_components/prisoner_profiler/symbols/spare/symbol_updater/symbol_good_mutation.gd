...
@onready var large_stat_screen_good_mutation_background : Array[ColorRect] = [
	$"../../../../../StatDisplay/StatPanels/StrengthStatPanel/CapControlTv/SubViewport/LargeStatDisplay/StatDisplay/SpareSymbols/GoodMutation/MutationBG",
