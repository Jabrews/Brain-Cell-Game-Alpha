...
# hint creation
var status_symbol_hint_p_s: PackedScene = preload("res://scenes/stations/station_components/cell_breeding/ui/cell_loader/cell_catalog/status_symbol_hint.tscn" )
