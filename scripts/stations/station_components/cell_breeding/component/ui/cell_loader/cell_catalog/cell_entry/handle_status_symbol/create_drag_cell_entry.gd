...
@onready var drag_cell_entry_p_s : PackedScene = preload("res://scenes/stations/station_components/cell_breeding/ui/cell_loader/cell_catalog/drag_cell_entry.tscn" )
