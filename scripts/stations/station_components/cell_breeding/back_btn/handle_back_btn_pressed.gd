...
@onready var screen_handle_back_btn_pressed : Node = $"../BreedPreviewTv/TvFrontPannel/SubViewport/ScreenCellBreedingLoader/HandleBackBtn"
...
func _handle_back_btn_pressed() :
	...
	if main_cell_manager.main_left_cell and main_cell_manager.main_right_cell :
		...
		screen_handle_back_btn_pressed._handle_btn_pressed()
	else: 
